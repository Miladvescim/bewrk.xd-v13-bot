...
let KıbrısKYLOCKZ = [message.guild.emojiGöster("kylockz_pat"),message.guild.emojiGöster("kylockz_heart"),message.guild.emojiGöster("kylockz_vis")];
var SlotOne = KıbrısKYLOCKZ[Math.floor(Math.random() * 3)]
var SlotTwo = KıbrısKYLOCKZ[Math.floor(Math.random() * 3)]
var SlotThree = KıbrısKYLOCKZ[Math.floor(Math.random() * 3)]
...
\`___SLOTS___\`
  ${message.guild.emojiGöster("kylockz_slot")} ${message.guild.emojiGöster("kylockz_slot")} ${message.guild.emojiGöster("kylockz_slot")}
\`|         |\`
\`|         |\`
