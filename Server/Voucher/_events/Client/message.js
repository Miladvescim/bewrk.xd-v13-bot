...
module.exports = async (message) => { 
    ...
    if(kylockz.commands.has(komutcuklar) || kylockz.aliases.has(komutcuklar) || TalentPerms) {
      ...
      try {
          ...
          calistirici = kylockz.commands.get(komutcuklar) || kylockz.aliases.get(komutcuklar);
          if(calistirici) {
            ...
            calistirici.onRequest(kylockz, message, args);
          }
      } catch (err) {
